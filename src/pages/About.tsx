...
export default function About() {
  return (
    <PageTransition key="about">
      <div className="relative z-10 container mx-auto px-6 pt-32 max-w-4xl pb-20 min-h-screen">
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-12">
          ...
          >
            <div>
              <h2 className="text-2xl font-display font-medium text-white mb-4">Background</h2>
            ...
            <div>
              <h2 className="text-2xl font-display font-medium text-white mb-4">Philosophy</h2>
              <p className="text-gray-400 text-lg leading-relaxed font-sans font-light">
            ...
            <div>
              <h2 className="text-2xl font-display font-medium text-white mb-4">Education</h2>
              <div className="bg-white/5 border border-white/10 rounded-2xl p-6 backdrop-blur-md">
                <div className="flex justify-between items-start mb-2">
                  <h3 className="text-xl font-bold text-white">University of Kentucky</h3>
                  <span className="text-blue-400 text-sm font-bold uppercase tracking-wider">In Progress</span>
                </div>
                <p className="text-gray-400 font-sans">B.S. Electrical Engineering & Cybersecurity</p>
              </div>
            </div>
          </motion.div>
        </div>
